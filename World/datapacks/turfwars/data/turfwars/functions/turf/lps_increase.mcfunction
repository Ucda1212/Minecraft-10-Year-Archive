#[ Lapis Team Turf Increase ]#

#: move turf line
tag @e[tag=turfwars.turf_line,sort=nearest,limit=1] add turfwars.lps_increase
execute as @e[tag=turfwars.turf_line,sort=nearest,limit=1] at @s run function turfwars:turf/move_line

#: update score
scoreboard players add turfwars.lps_turf turfwars.variables 1
scoreboard players remove turfwars.dmd_turf turfwars.variables 1
