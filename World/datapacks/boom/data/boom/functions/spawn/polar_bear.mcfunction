$summon polar_bear ~$(x) 106.05 ~$(y) {NoGravity:1b,Rotation:[-90.0f,0.0f],Age:-16724672,Attributes:[{Name:"generic.follow_range",Base:0},{Name:"generic.attack_damage",Base:0}],Tags:["boom.mob","boom.polar_bear","boom.setup"],CustomNameVisible:1b}
