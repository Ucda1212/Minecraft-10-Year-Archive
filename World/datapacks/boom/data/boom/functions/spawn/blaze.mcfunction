$summon blaze ~$(x) 106.05 ~$(y) {NoGravity:1,Attributes:[{Base:0,Name:"generic.follow_range"},{Base:0,Name:"generic.attack_damage"}],Tags:["boom.mob","boom.blaze","boom.setup"],CustomNameVisible:1b}
