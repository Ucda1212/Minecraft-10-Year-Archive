$summon villager ~$(x) 106.05 ~$(y) {NoGravity:1,Silent:1b,Rotation:[0.0f,0.0f],Tags:["boom.mob","boom.villager","boom.setup"],CustomNameVisible:1b}
scoreboard players set @e[type=#boom:mobs,tag=boom.setup] boom.explode 11
