$summon wandering_trader ~$(x) 106.05 ~$(y) {NoGravity:1b,Rotation:[90.0f,0.0f],Offers:{Recipes:[]},Attributes:[{Name:"generic.follow_range",Base:0},{Name:"generic.attack_damage",Base:0}],Tags:["boom.mob","boom.wandering_trader","boom.setup"],CustomNameVisible:1b}
scoreboard players set @e[type=#boom:mobs,tag=boom.setup] boom.explode 10
