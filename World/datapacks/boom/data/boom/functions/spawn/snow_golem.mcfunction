$summon snow_golem ~$(x) 106.05 ~$(y) {NoGravity:1b,Rotation:[180.0f,0.0f],Attributes:[{Name:"generic.follow_range",Base:0},{Name:"generic.attack_damage",Base:0}],Tags:["boom.mob","boom.snow_golem","boom.setup"],CustomNameVisible:1b}
