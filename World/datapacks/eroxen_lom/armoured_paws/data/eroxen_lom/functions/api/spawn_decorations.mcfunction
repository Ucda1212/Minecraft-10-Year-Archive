...
summon minecraft:item_display -102 121.5 224 {Rotation:[135f,0f],Tags:["eroxen_lom.decoration"],item:{Count:1b,id:"minecraft:orange_tulip",components:{"minecraft:custom_model_data":1}}}
...
summon minecraft:item_display -104.5 123.4 217.7 {Rotation:[-20f,-10f],Tags:["eroxen_lom.decoration"],item:{Count:1b,id:"minecraft:orange_tulip",components:{"minecraft:custom_model_data":3}},transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[2f,2f,2f]}}
...
summon minecraft:item_display -100 122.6 219 {Rotation:[0f,0f],Tags:["eroxen_lom.decoration"],item:{Count:1b,id:"minecraft:orange_tulip",components:{"minecraft:custom_model_data":4}},transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[0.7f,0.7f,0.7f]}}
